      ...
      <div>
        <div className="mb-15">
          ...
          <div className="flex items-center justify-end space-x-2">
            <div className="bg-apna text-white rounded-2xl px-4 py-2 md:py-1 text-3xl md:text-5xl flex items-center justify-center font-outfit">
              {number}
            </div>
            <span className="text-4xl md:text-6xl outfit-light text-dark">media</span>
          </div>
          <div className="text-lg md:text-2xl text-gray-800 text-left ps-6 md:ps-14">
            music & video
          </div>
