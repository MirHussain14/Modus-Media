  ...
  const defaultFeatures = [
    {
      title: "ימי עשיה",
      description:
        "שירות מהיר ויעיל עד 3 ימי עשיה. נותנים לכם פתרון מהיר ומקצועי בזמן קצר",
    },
    {
      title: "יחידות איכות",
      description:
        "שירות איכותי ומקצועי עם ציוד איכותי. נותנים לכם שירות מקצועי עם ציוד איכותי",
    },
    {
      title: "דלמה טכנולוגיה",
      description:
        "שירות מקצועי עם טכנולוגיה מתקדמת. נותנים לכם פתרון טכנולוגי מתקדם",
    },
    {
      title: "תכנון שמעשים",
      description:
        "שירות תכנון מקצועי וחדשני. נותנים לכם פתרון תכנון מקצועי ויעיל",
    },
    {
      title: "יתח הכרה",
      description:
        "שירות מקצועי ויעיל לכל הצרכים. נותנים לכם פתרון מלא ומקצועי",
    },
    {
      title: "תמיכה זמינות 24/7",
      description:
        "תמיכה טכנית זמינה 24 שעות ביממה 7 ימים בשבוע. נותנים לכם תמיכה מלאה",
    },
  ];
