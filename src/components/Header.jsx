...
const Header = ({ mondayData }) => {
  ...
  return (
    ...
    >
      {/* Vertical Label */}
      <div className="absolute hidden md:block -top-[7%] right-3 md:right-10 h-full">
      ...
      <div className="flex w-full flex-col md:flex-row items-start justify-between">
        <div className="flex flex-col space-y-1 h-full justify-between">
          <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 mb-2 sm:mb-3 md:mb-4 w-full">
            ...
            <span className="text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-4xl font-light w-full whitespace-nowrap font-outfit">
          ...
          <div className="space-y-1 sm:space-y-2 hidden md:block">
            <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
              ...
              <span className="text-sm sm:text-base md:text-lg lg:text-xl font-medium font-outfit">
                039521528
              </span>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
        ...
        <div
          dir="ltr"
          className="lg:mt-0 mt-0 md:mt-5 space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-8 pe-4 lg:w-auto text-right md:pe-34 lg:pe-0"
        >
          <div>
