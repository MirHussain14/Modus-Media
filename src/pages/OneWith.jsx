...
const OneWith = () => {
  ...
  useEffect(() => {
    const fetchDataAndGeneratePDF = async () => {
      ...
      setTimeout(async () => {
        try {
          const mainWrapper = document.querySelector(".onewith");
          ...
          img.onload = async function () {
            ...
            const fileName = `modus-media-one-with-${timestamp}.pdf`;
  ...
  const downloadSiteSVG = () => {
    ...
    a.href = url;
    a.download = pdfFile.name || "modus-media-one-with.pdf";
