...
import TwoWithPDF from "../pdf/pages/TwoWithPDF";
...
const TwoWith = () => {
  ...
  useEffect(() => {
    const fetchDataAndGeneratePDF = async () => {
      ...
      setTimeout(async () => {
        try {
          const mainWrapper = document.querySelector(".twowith");
          ...
          img.onload = async function () {
            ...
            const fileName = `modus-media-two-with-${timestamp}.pdf`;
  ...
  const downloadSiteSVG = () => {
    ...
    a.href = url;
    a.download = pdfFile.name || "modus-media-two-with.pdf";
