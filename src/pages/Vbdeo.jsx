...
import VbdeoPDF from "../pdf/pages/VbdeoPDF";
...
const Vbdeo = () => {
      ...
      setTimeout(async () => {
        try {
          ...
          img.onload = async function () {
            ...
            const fileName = `modus-media-vbdeo-${timestamp}.pdf`;
  ...
  const downloadSiteSVG = () => {
    ...
    a.href = url;
    a.download = pdfFile.name || "modus-media-vbdeo.pdf";
  ...
  const package2Features = [
    ...
    },
    {
      ...
      text: (
        <>
          פתרון ענן, עד 2 <br /> נגן וידאו חכם פתרון ענן
        </>
      ),
    },
    {
