...
const BundleServicesCardPDF = ({
  ...
  const getDisplayPrice = () => {
    if (mondayData[0]?.column_values[0]?.text) {
      return mondayData[0].column_values[0].text;
    }
    return "170";
  };
  ...
  return (
    <div>
      ...
      <div className="flex justify-between gap-0 w-full ps-3 ms-auto items-center mt-20">
        <div className="right">
          <p className="text-sm text-blue-900">+ מע"מ</p>
          <p className="text-sm text-gray-500">לחודש</p>
          <p className="text-sm text-gray-500">{quantityText}</p>
        </div>
...
export default BundleServicesCardPDF;
