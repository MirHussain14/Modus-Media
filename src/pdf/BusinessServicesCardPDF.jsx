...
const BusinessServicesCardPDF = ({ 
  ...
  return (
    <div className="bg-[#FAFAFA] w-[450px] max-w-[500px] rounded-3xl p-8 text-right flex flex-col relative">
      <h1
        dir="rtl"
...
export default BusinessServicesCardPDF;
