...
import BundleServicesCardPDF from "../BundleServicesCardPDF";
import BundlePricingPDF from "../BundlePricingPDF";
const BundleWithPDF = () => {
  ...
  return (
    <div className="min-h-screen py-8 px-4 bundlewith opacity-0 absolute top-0 left-0">
