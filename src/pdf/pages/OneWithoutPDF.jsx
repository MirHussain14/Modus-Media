...
const OneWithoutPDF = () => {
  ...
  const package2Features = [
    ...
    },
    {
      ...
      text: (
        <>
          ואפליקצית המובייל <br /> תמיכה טכנית עבור תוכנת הנגן
        </>
      ),
    },
  ];
  ...
  return (
    <div className="min-h-screen py-8 px-4 onewithout opacity-0 absolute top-0 left-0">
